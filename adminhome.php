          ...
          if ($result->num_rows > 0) {
            ...
            echo  '<tr>';
                echo '<td style="width: 200px;" align="center">'.$row["post_id"].'</td>'
                  ...
                  ."<td style = 'width: 200px;' align='center;'><a href='adminviewpost.php? token=" . $row["post_id"] . "'> Viewpost </a><span>|</span><a href='adminprintpostindiv.php? token=" . $row["post_id"] . "'target= 'blank'> Print </td>" 
                  .'</tr>';   
            }
          } else {
            echo "0 results";
